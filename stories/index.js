...
storiesOf("DayListItem", module)
  ...
  .add("Unselect", () => <DayListItem name="Monday" spots={5} />)
...
storiesOf("InterviewerListItem", module)
  ...
  const interviewers = [
    ...
    {id: 4, name: "Cohana Roy", avatar: "https://i.imgur.com/FK8V841.png"},
  ...
  storiesOf("Appointment", module)
      ...
      .add("Edit", () => <Form student="Stephanie" interviewer={1} interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")}/>)
